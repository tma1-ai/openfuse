 ...
 * IF NOT EXISTS`), so re-running is safe. `0002_retention.sql` is the opt-in
 * global TTL and is applied as part of the same migration set — there is no
 * separate retention step.
 *
