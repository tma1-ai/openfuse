  ...
  createAnnotationScore: protectedProjectProcedure
    ...
    .mutation(async ({ input, ctx }) => {
      ...
      await upsertScore({
        ...
        timestamp: convertDateToDbDateTime(timestamp),
        ...
        created_at: convertDateToDbDateTime(score.createdAt),
        updated_at: convertDateToDbDateTime(score.updatedAt),
    ...
    .mutation(async ({ input, ctx }) => {
      ...
      if (!score) {
        ...
        await upsertScore({
          id: input.id,
          project_id: input.projectId,
          timestamp: convertDateToDbDateTime(score.timestamp),
